...
namespace AppShopping.Services
{
    ...
    {
        public List<Estabilishment> GetAllRestaurants()
        {
        ...
        {
            public static List<Estabilishment> GetRestaurants()
            {
                return new List<Estabilishment>
                    {
                        new Estabilishment()
                        {
                            Id = 31,
                            ...
                            Phone = "(61) 3550-1874",
                            Type = EstablishmentType.Restaurants,
